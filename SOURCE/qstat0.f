...
c		if(l.eq.1) then
c		write(6,*)'bm1=',bm1
c		write(6,*)'First displ-stress vec below source=',(c(i,1), i=1,4) 
c		write(6,*)'Second displ-stress vec below source=',(c(i,2), i=1,4) 
c		write(6,*)'bm2=',bm2
c		write(6,*)'First displ-stress vec above source=',(c(i,3), i=1,4) 
c		write(6,*)'Second displ-stress vec above source=',(c(i,4), i=1,4) 
c		endif
	do 135 i=1,4
	do 140 j=1,4
	bc0(j,i)=0.d0
...
135	continue
cTE
c	Stabilize the l=1 solution. Set displacements below the source radius to very small value.
	if(l.eq.1) then
	bc0(1,1)=1.d+6
	bc0(2,2)=1.d+6
	bc0(3,1)=1.d+6
